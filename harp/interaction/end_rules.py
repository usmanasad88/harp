...
Silence-based ending (nobody has spoken for a while) is a separate future rule;
this module implements the face-absence rule only.
"""
...
class EndOfInteractionMonitor:
    ...
    async def _run_countdown(self) -> None:
        ...
        await self._bus.publish(EndOfInteractionDetected(reason=reason))
