...
_STATIC_FILES = {
    ...
    # The animated face display (robot's face screen): glowing eyes + mouth,
    # mood driven by PresenceChanged on the same /ws bus stream — no separate
    # server/polling (see face.js for why PresenceChanged and not the old
    # gimbal-only on_face_change signal).
