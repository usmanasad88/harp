...
local HTTP flag, imports nothing from harp.motion. The gimbal (also a separate
process, harp/motion/gimbal.py) keeps tracking faces the entire time regardless
of whether patrol or voice currently has the floor.
"""
